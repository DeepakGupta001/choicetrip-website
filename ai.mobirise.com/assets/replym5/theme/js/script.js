        ...
        if (!isBuilder) {
            ...
            document.querySelectorAll('.modalWindow-video > iframe').forEach(function(el) {
                ...
                if (videoURL.indexOf('youtu') !== -1) {
                    ...
                    if (posterEl) {
                        newVideo.setAttribute('poster', posterEl.src)
                    };
...
! function() {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.innerHTML = '<a href="https://mobirise.com/offline-website-builder.html">Offline Website Software</a> Mobirise v5.9.19 <a href="https://mobirise.com/builder/ai-website-builder.html">Free AI Website Builder</a>';
